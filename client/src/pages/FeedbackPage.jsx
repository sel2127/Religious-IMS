...
const FeedbackPage = () => {
  return (
    <div className="w-full m-auto ">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 mt-8">
        {data.map((data) => (
          <div key={data.id} className='h-auto bg-gray-300 text-black rounded-xl'>
