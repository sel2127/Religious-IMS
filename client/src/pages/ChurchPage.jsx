  ...
  return (
    ...
    <div className='pt-8'>
      ...
      <div className=' inline-block relative'>
          <img src={photo3} alt="Image" className="object-cover w-full h-full" />
      ...
      <div className='flex flex-col lg:flex-row py-8'>
        <div className='lg:w-1/2 p-4'>
          <h1 className='text-3xl md:text-2xl sm:text-xl text-dark-blue font-bold mb-4 text-center'>የአባቶች ምክር
          </h1>
          <p className='text-sm md:text-base lg:text-lg'>
        ...
        <div className='lg:w-1/2 p-4'>
          ...
          <h1 className='text-3xl md:text-2xl sm:text-xl text-dark-blue font-bold mb-4 text-center'>መልዓከ ፀሃይ አባ ገብርኤል</h1>
