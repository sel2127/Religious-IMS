    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-3 gap-6 mt-4">
                <div>
                    <div className="aspect-w-1 aspect-h-1 imgListHeight">
                        <img src={lalibela} alt="lalibela rock hewn church" className="w-full h-full object-contain transition-transform transform hover:scale-105" />
                    </div>
                    <div>
                        <h1 className="text-center text-xl mt-4 mb-4">የቤተ ክርስቲያን ጥገና እና እድሳት</h1>
                        <p className="text-sm m-4">ልገሳዎች ለቤተክርስቲያን ህንጻዎች ጥገና፣ እድሳት ወይም ማስፋፊያ፣ ጥገና፣ ስዕል እና የመሠረተ ልማት ማሻሻያዎችን ጨምሮ ሊያገለግሉ ይችላሉ::
                            ልገሳዎች ለቤተክርስቲያን ህንጻዎች ጥገና፣ እድሳት ወይም ማስፋፊያ፣ ጥገና፣ ስዕል እና የመሠረተ ልማት ማሻሻያዎችን ጨምሮ ሊያገለግሉ ይችላሉ:
                        </p>
                    </div>
                    <div className="flex justify-center items-center mt-8">
                        <button className="bg-dark-blue text-white px-4 py-2 rounded-full transform hover:scale-110 hover:bg-blue-400" style={{ width: '150px' }} >Donate</button>
                    </div>
                </div>

                <div>
                    <div className="aspect-w-1 aspect-h-1 imgListHeight">
                        <img src={lalibela_two} alt="hymn inside lalibela rock hewn church" className="w-full h-full object-contain transition-transform transform hover:scale-105" />
                    </div>
                    <div>
                        <h1 className="text-center text-xl mt-4 mb-4">የቤተ ክርስቲያን ጥገና እና እድሳት</h1>
                        <p className="text-sm m-4">ልገሳዎች ለቤተክርስቲያን ህንጻዎች ጥገና፣ እድሳት ወይም ማስፋፊያ፣ ጥገና፣ ስዕል እና የመሠረተ ልማት ማሻሻያዎችን ጨምሮ ሊያገለግሉ ይችላሉ::
                ...
                <div>
                    <div className="aspect-w-1 aspect-h-1 imgListHeight">
                        <img src={boleMedhanealem} alt="bole medhanealem church" className="w-full h-full object-contain transition-transform transform hover:scale-105" />
                    </div>
                    <div>
                        <h1 className="text-center text-xl mt-4 mb-4">የቤተ ክርስቲያን ጥገና እና እድሳት</h1>
                        <p className="text-sm m-4">ልገሳዎች ለቤተክርስቲያን ህንጻዎች ጥገና፣ እድሳት ወይም ማስፋፊያ፣ ጥገና፣ ስዕል እና የመሠረተ ልማት ማሻሻያዎችን ጨምሮ ሊያገለግሉ ይችላሉ::
            ...
            <div className="grid grid-cols-3 gap-6 mt-16">
                <div>
                    <div className="aspect-w-1 aspect-h-1 imgListHeight">
                        <img src={churchInAksum} alt="church in axsum" className="w-full h-full object-contain transition-transform transform hover:scale-105" />
                    </div>
                    <div>
                        <h1 className="text-center text-xl mt-4 mb-4">የቤተ ክርስቲያን ጥገና እና እድሳት</h1>
                        <p className="text-sm m-4">ልገሳዎች ለቤተክርስቲያን ህንጻዎች ጥገና፣ እድሳት ወይም ማስፋፊያ፣ ጥገና፣ ስዕል እና የመሠረተ ልማት ማሻሻያዎችን ጨምሮ ሊያገለግሉ ይችላሉ::
                ...
                <div>
                    <div className="aspect-w-1 aspect-h-1 imgListHeight">
                        <img src={abrehaAtsbeha} alt="Abreha Atsbeha" className="w-full h-full object-contain transition-transform transform hover:scale-105" />
                    </div>
                    <div>
                        <h1 className="text-center text-xl mt-4 mb-4">የቤተ ክርስቲያን ጥገና እና እድሳት</h1>
                        <p className="text-sm m-4">ልገሳዎች ለቤተክርስቲያን ህንጻዎች ጥገና፣ እድሳት ወይም ማስፋፊያ፣ ጥገና፣ ስዕል እና የመሠረተ ልማት ማሻሻያዎችን ጨምሮ ሊያገለግሉ ይችላሉ::
                ...
                <div>
                    <div className="aspect-w-1 aspect-h-1 imgListHeight">
                        <img src={debredamo} alt="Debre Damo Monastery" className="w-full h-full object-contain transition-transform transform hover:scale-105" />
                    </div>
                    <div>
                        <h1 className="text-center text-xl mt-4 mb-4">የቤተ ክርስቲያን ጥገና እና እድሳት</h1>
                        <p className="text-sm m-4">ልገሳዎች ለቤተክርስቲያን ህንጻዎች ጥገና፣ እድሳት ወይም ማስፋፊያ፣ ጥገና፣ ስዕል እና የመሠረተ ልማት ማሻሻያዎችን ጨምሮ ሊያገለግሉ ይችላሉ::
