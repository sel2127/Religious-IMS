      ...
      <div>
        ...
        <div className="flex py-3 font-bold border-b border-gray-300">
          <div className="w-5/6 flex items-center">
            ...
            <div class="w-1/6 flex items-center relative">
              <div class="mr-1 cursor-pointer dropdown-trigger">ለሎች ገጾች</div>
              <div class="dropdown-content hidden absolute bg-white mt-2 py-2 w-24 shadow-lg rounded-md">
                <div class="dropdown-item cursor-pointer">አስተያየት</div>
                <div class="dropdown-item cursor-pointer">አግኙን</div>
                <div class="dropdown-item cursor-pointer">ደብር</div>
              </div>
              <div>
